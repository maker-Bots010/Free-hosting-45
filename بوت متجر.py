<?php
ob_start();
$Marcus = "7988407355:AAHuO_gUoua-4uyVU2xK_QLjMnMoraRTqTY";
...
-",
   'reply_markup'=>json_encode([
     'inline_keyboard'=>[
     [['text'=>"مطور البوت 🛍",'url'=>"tg://user?id=6704860429" ]],
       ...
       [['text'=>' رسالة الترحيب (start) ','callback_data'=>"startjj"]],
       [['text'=>'  قسم الحظر ️','callback_data'=>"band"],['text'=>'قسم الادمنيه️','callback_data'=>"addadm"]],
       [['text'=>"قسم الاشتراك الاجباري ",'callback_data'=>"ch"]],
       [['text'=>'قسم الاحصائيات ','callback_data'=>"starts"],['text'=>"قسم الاذاعه ",'callback_data'=>"adaan"]],
       [['text'=>' اعدادات بوت المتجر ','callback_data'=>"stengbott"]],
       ]
    ])
  ]);
}
...
[['text'=>'  جميع العروض','callback_data'=>'del']],
[['text'=>' إضافة عرض','callback_data'=>'add'],['text'=>' حذف عرض','callback_data'=>'deljj']],
[['text'=>"عرض كمية العروض المتوفره : $saless",'callback_data'=>'saless']],
[['text'=>'  تعيين قناة إثباتات','callback_data'=>'shh'],['text'=>' قسم النقاط','callback_data'=>"Nkatn"]],
...
[['text'=>" اختصار روابط️  : $alroadttt",'callback_data'=>'alroadttt'],['text'=>"تحويل ملكية البوت ‍",'callback_data'=>'mlk']],
[["text"=>"➡️","callback_data"=>"c"]],
]])
]);   
}
...
start - رساله البدء ',
    'reply_markup'=>json_encode([
     'inline_keyboard'=>[
      [['text'=>'- إلغاء الأمر ‼️','callback_data'=>'c']]
      ]
    ])
  ]);
  $stingggg['modee'] = 'add';
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"رجوع ،➡️","callback_data"=>"adaan"]],
]])
]);   
if($text){
...
/*null*/
if($start == null){
$hello =  "🎉 مرحباً بك في عالم التسوق المثير، عزيزي $name ️! 👋🏼

🚀 هنا، يُمكنك أن تدخل في رحلة لاكتساب النقاط واستبدالها بعروض خلابة! 💵✨

👀 استعرض الأقسام المتاحة واختر ما يروق لك لتبدأ مغامرتك التسوقية الآن من الكيبورد أدناه 👇🏽. استمتع!";
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"➡️","callback_data"=>"stengbott"]],
]])
]);   
$sales['mode'] = 'coc1';
save($sales);
  ...
  $reply_markup['inline_keyboard'][] = [['text'=>'الرد','callback_data'=>'s'],['text'=>'🗑️','callback_data'=>'s']];
	foreach($rdod['rd'] as $key => $cutalue){
		$reply_markup['inline_keyboard'][] = [['text'=>$key,'callback_data'=>"s"],['text'=>'🗑️','callback_data'=>"delrd×".$key]];
		  ...
		  $reply_markup['inline_keyboard'][] = [['text'=>'➡️','callback_data'=>'rdod']];
$json = json_encode($reply_markup);
bot('EditMessageText',[
  'chat_id'=>$chat_id,
  'message_id'=>$message_id,
...
[['text'=>"تصفير النقاط ",'callback_data'=>'delallnkat'],['text'=>'  إنشاء هدية','callback_data'=>"offerfree"]],
[['text'=>'  إرسال نقاط للكل','callback_data'=>"sendcoincc"],['text'=>'  خصم نقاط للكل','callback_data'=>"sendcoinxx"]],
[['text'=>'تعيين الدخول ','callback_data'=>"setengss"],['text'=>'تعيين الهديه اليوميه ','callback_data'=>"hadehday"]],
...
[["text"=>"رجوع ،➡️","callback_data"=>"stengbott"]],
]])
]);   
}
}
...
[['text'=>"رفع مشرف ⁦️⁩",'callback_data'=>"addadmin"],['text'=>"تنزيل مشرف ⁦",'callback_data'=>"deladmin"]],
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"ارسل الايدي الان لتحويل الملكيه 
...
bot('sendmessage',[
'chat_id'=>$text,
'text'=>"تم تحويل الملكيه لك بنجاح ‍✔",
]);
...
unlink("mlkk");
 ...
 if($data == 'add'){
  bot('editMessageText',[
    ...
    'reply_markup'=>json_encode([
     'inline_keyboard'=>[
      [['text'=>'- إلغاء الأمر ‼️','callback_data'=>'stengbott']]
      ]
    ])
  ]);
  $sales['mode'] = 'add';
...
save($sales);}
 if($text != '/start' and $message->photo != null and $sales['mode'] == 'photo'){
  ...
  bot('sendMessage',[
   ...
   'text'=>"تم حفظ الصورة✓
🏷  الكود: (`$code` )
📚  ارسل العرض اللذي تريد تسليمه  تلقائياً
...
ارسل عدد مرات بيع العرض

اذا تريد بيع العرض للجميع اضغط على غير محدود ♻️',
'reply_to_message_id'=>$message->message_id, 
    'reply_markup'=>json_encode([
     'inline_keyboard'=>[
...
if(is_numeric($text) and $sales['mode'] == 'Numbers'){
  ...
  bot('sendMessage',[
   'chat_id'=>$chat_id,
   'text'=>'
- تم حفظ عدد مرات بيع العرض
وتم اضافة العرض بنجاح ✓
',
'reply_to_message_id'=>$message->message_id, 
    'reply_markup'=>json_encode([
     'inline_keyboard'=>[
...
[["text"=>"➡️","callback_data"=>"stengbott"]],
 ...
 if(in_array($chat_id,$stingggg['stingggg']['admins']) or $chat_id == $admin){
 	$reply_markup = [];
  $reply_markup['inline_keyboard'][] = [['text'=>'اسم العرض ','callback_data'=>'s'],['text'=>'حذف 🗑️','callback_data'=>'s'],['text'=>'تعديل ✍🏻','callback_data'=>'s']];
  ...
  $reply_markup['inline_keyboard'][] = [['text'=>'- إلغاء الأمر ‼️','callback_data'=>'stengbott']];
$json = json_encode($reply_markup);
  bot('editMessageText',[
    'chat_id'=>$chat_id,
    'message_id'=>$message_id,
...
$sales = json_decode(file_get_contents('sales.json'),true);
 	$reply_markup = [];
  $reply_markup['inline_keyboard'][] = [['text'=>'اسم العرض 🎟️','callback_data'=>'s'],['text'=>'حذف 🗑️','callback_data'=>'s'],['text'=>'تعديل ✍🏻','callback_data'=>'s']];
  foreach($sales['sales'] as $code => $sale){
   $reply_markup['inline_keyboard'][] = [['text'=>$sale['name'],'callback_data'=>"s"],['text'=>'🗑️','callback_data'=>'del×'.$code],['text'=>'✍🏻','callback_data'=>'edit×'.$code]];
  }
  $reply_markup['inline_keyboard'][] = [['text'=>'- إلغاء الأمر ‼️','callback_data'=>'stengbott']];
...
$json = json_encode($reply_markup);
  bot('editMessageText',[
    'chat_id'=>$chat_id,
    'message_id'=>$message_id,
    'text'=>'العرض غير موجودة يمكنك المحاولة مجددا',
    'reply_markup'=>$json
  ]);
 }
 }
 ...
 if(in_array($chat_id,$stingggg['stingggg']['admins']) or $chat_id == $admin){
   ...
   [['text'=>"تسليم العرض 🎟️",'callback_data'=>'sales×'.$ex[1]]],
...
save($sales);
  ...
  if(in_array($chat_id,$stingggg['stingggg']['admins']) or $chat_id == $admin){
    ...
    'chat_id'=>$chat_id,
    'message_id'=>$message_id,
    'text'=>'قم بإرسال عدد مرات بيع العرض الجديد',
    'reply_markup'=>json_encode([
    'inline_keyboard'=>[
...
exit;
 ...
 if($data == 'deljj'){
 	$reply_markup = [];
  $reply_markup['inline_keyboard'][] = [['text'=>'اسم العرض 🎟️','callback_data'=>'s'],['text'=>'حذف 🗑️','callback_data'=>'s']];
  foreach($sales['sales'] as $code => $sale){
...
اختر العرض المراد حذفها الذي تريد حذفها 

اذا لا تريد حذف العرض اضغط على الغاء الامر ',
    'reply_markup'=>$jsonn
  ]);
 }else{
 	$reply_markup = [];
...
'chat_id'=>$chat_id,
'text'=>"
تم التحقق بانك ليست روبوت تهانينا ♻️
...
if($message and $botsjj['botss'] == 'on'){
	bot('sendmessage',[
      'chat_id'=>$chat_id,
      "text"=>"
♻️ يجب عليك الإشتراك في قناة البوت أولاً 
♻️ $CHHHH
...
return false;}
 if(preg_match("/\/(start)/",$text )){
    ...
    'text'=>"- لقد دخل شخص  لرابط الدعوة الخاص بك  ولقد ربحت $setengssj نقطه
      معلومات عنه :
      ايديه  : [$from_id](tg://user?id=$from_id)
      معرفه ان وجد ⁦ : [@$user](tg://user?id=$from_id)
      اسمه ✨ : [$name](tg://user?id=$from_id)
...
'reply_to_message_id'=>$message->message_id, 
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
     ...
     [['text'=>'الخدمات 🛍','callback_data'=>'alllslaa'],['text'=>'تجميع النقاط 🔰','callback_data'=>'col']],
     [['text'=>'الحساب 📊','callback_data'=>'about'],['text'=>'تحويل النقاط ♻️','callback_data'=>'refccoin']],
     [['text'=>"شراء نقاط 🏷️",'url'=>"t.me/N_A_M1"]],
   ] 
   ])
  ]);
}
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>" 🎉 مرحباً بك في عالم التسوق المثير، عزيزي $name ️! 👋🏼
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>"❌  لايوجد قناة تمت اضافتها هنا  يرجى المحاولة مره اخرى لاحقا ⏰",
'reply_markup'=>json_encode([ 
'inline_keyboard'=>[
[['text'=>"➡️",'callback_data'=>"col"]],
]
])
]);
}
...
♻️ يرجى المحاولة مره اخرى لاحقا ",
'reply_markup'=>json_encode([ 
'inline_keyboard'=>[
[['text'=>"➡️",'callback_data'=>"col"]],
]
...
'chat_id'=>$chat_id,
'message_id'=>$message_id,
'text'=>" ➪ تجميع النقاط مجانا 🍿",
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
   [['text'=>" رابط الدعوة 🗃",'callback_data'=>"ra1"]],
   [['text'=>" اشتراك في القنوات 🔰",'callback_data'=>"chs"]],
   [['text'=>"$adayy",'callback_data'=>"kk"]],
   [['text'=>"$atho",'callback_data'=>"refccoin"]],
...
$reply_markup['inline_keyboard'][] = [['text'=>'➡️','callback_data'=>'col']];
...
$almtvhg = "الوضع المتطور ♻️";
}else{
$almtvhg = "";
}
     bot('sendmessage',[
     'chat_id'=>$chat_id, 
    'text'=>"* حسناً عزيزي اختر وضع عرض العروض الذي تريده 🧾 *",
  'parse_mode'=>"MarkDown",
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
[['text'=>"الوضع الكلاسيكي ♻️",'callback_data'=>"salessyhya"],['text'=>"$almtvhg",'callback_data'=>"motatwr"]],
[['text'=>"➡️",'callback_data'=>"back"]],
    ] 
   ])
  ]);
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"شراء العرض 🛍",'callback_data'=>$codee]],
[['text'=>"التالي",'callback_data'=>"num&&t".$t]],
[['text'=>"➡️",'callback_data'=>"alllslaa"]],
],
]),
]);
}
...
$ajj = "";
  ...
  $reply_markup = [];
  $reply_markup['inline_keyboard'][] = [['text'=>"$ajj",'callback_data'=>'s'],['text'=>'السعر 💰','callback_data'=>'s'],['text'=>'إسم العرض 🏷️','callback_data'=>'s']];
  foreach($sales['sales'] as $code => $sale){
...
$reply_markup['inline_keyboard'][] = [['text'=>'بحث عن عرض 🍿','callback_data'=>'search'],['text'=>'العروض التي يمكنك شرائها','callback_data'=>'prsla']];
$reply_markup['inline_keyboard'][] = [['text'=>'العودة إلى قائمة العروض ➡️','callback_data'=>'alllslaa']];
  $reply_markup = json_encode($reply_markup);
  bot('editMessageText',[	
...
بحال واجهتك مشاكل في استلام عرض قم بمراسلة الادمن  : @$JAMALJO
",
  "message_id"=>$message_id
  ]);
  $sttings["sal3h"]+=1;
...
طريقة التسليم : تلقائي ✨
 هل أنت متأكد أنك تريد شراء",
   'reply_markup'=>json_encode([
     ...
     bot('answercallbackquery',[
      'callback_query_id' => $update->callback_query->id,
'text'=>"نقاطك غير كافية لشراء هذا العرض ‼️
الإسم العرض :$name 🔖
سعر العرض :$price نقطة 💰 
وصف العرض 📄 : $caption
طريقة التسليم : تلقائي ✨
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
[['text'=>" رجوع  ➡️",'callback_data'=>"salessyhya"]],
    ] 
   ])
  ]);
...
$reply_markup['inline_keyboard'][] = [['text'=>'بحث عن عرض 🍿','callback_data'=>'search']];
$reply_markup['inline_keyboard'][] = [['text'=>'العودة إلى قائمة العروض ➡️','callback_data'=>'alllslaa']];
  $reply_markup = json_encode($reply_markup);
  bot('sendmessage',[
   'chat_id'=>$chat_id,
